...
if 1:
    ...
    lod = torch.load('/art/Simsiam/ckpt/simsiam-tiny-preresnet18_0826084548.pth')
    print(lod.keys())
    ...
    lod = torch.load('/art/ACL/Adversarial-Contrastive-Learning/checkpoints/ACL_Tiny_adv_align/model_980.pt')
    ...
    #lod = torch.load('/art/MoCo/encoder_q_dict_0800.pth (1).tar')
    #lod = torch.load('/art/MoCo/encoder_q_dict_0051.pth.tar')
    print(lod.keys())
...
classifier.fit_predict(x_train, y_train, x_test, y_test, batch_size=64, nb_epochs=11)
