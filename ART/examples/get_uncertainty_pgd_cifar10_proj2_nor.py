...
class CNN_Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        #print("Encoder x: {}".format(x.min()))
        x = x.view(-1, *self.input_size)
        down1 = self.down1(x)
        #print("Encoder down1: {}".format(down1.shape))
        #print("Encoder down1: {}".format(down1.min()))
