...
#input_sample = sample[0] + noise * 0.05
#input_sample = sample[0] + noise * 0.09
#input_sample = sample[0] + noise * 0.14
#input_sample = sample[0] + noise * 0.16

#input_sample = sample[0] + noise * 0.10
input_sample = sample[0] + noise * 0.09
...
save_image(d_img, "/art/vis/ae/d.png")
...
save_image(d_proj_img, "/art/vis/ae/d_proj.png")
