...
class CNN_Encoder(nn.Module):
    ...
    def forward(self, inputs):
        ...
        print("Encoder down3: {}".format(down3.shape))
        down4, indices_4, unpool_shape4 = self.down4(down3)
        print("Encoder down4: {}".format(down4.shape))
        ...
        print("Decoder up4: {}".format(up4.shape))
        up3 = self.up3(up4, indices_3, unpool_shape3)
        print("Decoder up3: {}".format(up3.shape))
        up2 = self.up2(up3, indices_2, unpool_shape2)
        print("Decoder up2: {}".format(up2.shape))
...
#model3.load_state_dict(torch.load('/art/model_cifar/ae/model_ae_dim512_.model'))
...
#classifier.save('model_ae_dim512_','/art/model_cifar/ae/')
