...
#model3.load_state_dict(torch.load('/art/model_cifar/ae/model_ae_dim128_.model'))
#model3.load_state_dict(torch.load('/art/model_cifar/ae/model_ae_dim128_c100.model'))
model3.load_state_dict(torch.load('/art/model_cifar/ae/model_ae_dim128_C400.model'))
...
for i in range(1):
    ...
    f_name = "/art/vis_cifar/ae/ae400_image_"+str(i)+".png"
...
classifier.fit_ae(x_train, y_train, batch_size=32, nb_epochs=400)
#classifier.fit_ae(x_train, y_train, batch_size=32, nb_epochs=100)
...
#classifier.save('model_ae_dim128_','/art/model_cifar/ae/')
#classifier.save('model_ae_dim128_c100','/art/model_cifar/ae/')
#classifier.save('model_ae_dim128_C400','/art/model_cifar/ae/')
classifier.save('model_ae_dim128_C400+','/art/model_cifar/ae/')
...
for i in range(5):
    ...
    f_name = "/art/vis_cifar/ae/rec_ae400_image_"+str(i)+".png"
    save_image(rec_img_, f_name)
