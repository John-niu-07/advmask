...
classifier.save('model_cifar_AdvFt','/art/model_cifar/clr/')
#classifier.save('model_cifar_AdvFt_res18','/art/model_cifar/clr/')
...
#np.save('x_test_adv_res18.npy', x_test_adv)

#x_test_adv = np.load('x_test_adv.npy')
#x_test_adv = np.load('x_test_adv_res18.npy')
