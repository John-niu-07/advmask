...
#(x_train, y_train), (x_test, y_test), min_, max_ = load_dataset(str("tiny_split"))
(x_train, y_train), (x_test, y_test), min_, max_ = load_dataset(str("tiny64_split"))
...
classifier.fit_predict(x_train, y_train, x_test, y_test, batch_size=32, nb_epochs=81)
...
#classifier.save('model_tiny64_advftM_sp','/art/model_tiny/clr/')
classifier.save('model_tiny64__advftM_sp','/art/model_tiny/clr/')
print(err)
...
trainer = AdversarialTrainerMadryPGD(classifierD, nb_epochs=50, batch_size=64, eps= 8.0 /255.0, eps_step = 2.0/255.0)
