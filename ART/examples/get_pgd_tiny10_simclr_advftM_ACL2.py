...
if 0:
    ...
    #lod = torch.load('/art/Simsiam/ckpt_byol/byol-tiny-preresnet18_0830141342.pth')
    #print('byol')
...
class ResNetSimCLR_ft(nn.Module):
    ...
    def forward(self, x):
        ...
        #np.save('x'+str(self.kk)+'_tiny_woM.npy',x_save)
        #np.save('x'+str(self.kk)+'_tiny_wM.npy',x_save)
        #np.save('x'+str(self.kk)+'_tiny_woM_eps8.npy',x_save)
        np.save('x'+str(self.kk)+'_tiny_wM_eps8.npy',x_save)
        self.kk = self.kk + 1
        '''
...
if 0:
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_wM.model')
    model_ft = torch.load('/art/model_tiny/clr/model_tiny64_wM_eps4.model')
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_wM_eps8.model')
...
if 1:
    ...
    print('----------vis-----------------')
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_woM.model')
    model_ft = torch.load('/art/model_tiny/clr/model_tiny64_woM_eps4.model')
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_woM_eps8.model')
...
#classifier.save('model_tiny_woM','/art/model_tiny/clr/')
#classifier.save('model_tiny64_woM_eps4','/art/model_tiny/clr/')
#classifier.save('model_tiny_woM_eps8','/art/model_tiny/clr/')
...
#np.save('x_test_adv_tiny64_esp4.npy', x_test_adv)
#x_test_adv = np.load('x_test_adv_tiny64_esp4.npy')

#np.save('x_test_adv_tiny.npy', x_test_adv)
#x_test_adv = np.load('x_test_adv_tiny.npy')

#np.save('x_test_adv_tiny_eps8.npy', x_test_adv)
#x_test_adv = np.load('x_test_adv_tiny_eps8.npy')
...
trainer = AdversarialTrainerMadryPGD(classifierD, nb_epochs=40, batch_size=64, eps= 8.0 /255.0, eps_step = 2.0/255.0)
#trainer = AdversarialTrainerMadryPGD(classifierD, nb_epochs=40, batch_size=64, eps= 2.0 /255.0, eps_step = 2.0/255.0)
...
#classifierD.save('model_tiny_wM','/art/model_tiny/clr/')
#classifierD.save('model_tiny64_wM_eps4','/art/model_tiny/clr/')
#classifierD.save('model_tiny_wM_eps8','/art/model_tiny/clr/')
...
#np.save('x_test_adv2_tiny64_eps4.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_tiny64_eps4.npy')

#np.save('x_test_adv2_tiny.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_tiny.npy')

#np.save('x_test_adv2_tiny_eps8.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_tiny_eps8.npy')
