...
#model_ft = torch.load('/art/model_tiny/clr/model_tiny_advft_base.model')
...
classifier.fit_predict(x_train, y_train, x_test, y_test, batch_size=64, nb_epochs=71)
...
classifier.save('model_tiny_advft_base','/art/model_tiny/clr/')
