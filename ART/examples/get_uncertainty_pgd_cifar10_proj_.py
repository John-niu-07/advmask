...
#optimizer3 = optim.Adam(model3.parameters(), lr=0.01)
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer3, milestones=[100, 200, 300, 400], gamma=0.5)
...
#classifier.fit_ae(x_train, y_train, batch_size=256, nb_epochs=52)
...
#classifier.save('model_ae_dim128_mse___','/art/model_cifar/ae/')
