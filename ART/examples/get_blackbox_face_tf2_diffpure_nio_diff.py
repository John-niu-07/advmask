...
#print(test1_crop.shape)


#GAN
if 0:
    adv_patch = Image.open('/face/Mask/AdversarialMask/patch/experiments/April/13-04-2023_17-11-46/final_results/final_patch.png').convert('RGB') # stn mask9 full + mag
    adv_patch = Image.open('/face/Mask/AdversarialMask/patch/experiments/April/03-04-2023_18-17-46/final_results/final_patch.png').convert('RGB') # eye
    adv_patch = Image.open('/face/Mask/AdversarialMask/patch/experiments/April/05-04-2023_17-40-06/final_results/final_patch.png').convert('RGB') # T-shape
    adv_patch = transforms.ToTensor()(adv_patch).to('cuda').unsqueeze(0)

    adv_patch = functions.preprocess_face_woDet("/face/Mask/DiffusionCLIP/runs/test_FT_adv_CelebA_HQ_beards_id_1.0_l1_0.0_clip_0/image_samples/train_1_person_with_beards_10_ngen6.png", (250, 250)).squeeze(0) #diffusion crop
    adv_patch = transforms.ToTensor()(adv_patch).to('cuda').unsqueeze(0)



    img = functions.preprocess_face_woDet("/face/Mask/idinvert_pytorch/examples/r256/009_aligned.png", (250, 250)).squeeze(0)
    img = functions.preprocess_face_woDet("/face/Mask/AdversarialMask/datasets/CASIA/4204960/085_aligned.png", (250, 250)).squeeze(0)
    img = transforms.ToTensor()(img).to('cuda').unsqueeze(0)




    patch_mask = transforms.ToTensor()(Image.open('/face/Mask/AdversarialMask/datasets/012_mask9.png').convert('L')).to('cuda').unsqueeze(0)
    patch_mask = transforms.ToTensor()(Image.open('/face/Mask/AdversarialMask/datasets/012_mask7.png').convert('L')).to('cuda').unsqueeze(0)
    patch_mask = transforms.ToTensor()(Image.open('/face/Mask/AdversarialMask/datasets/012_mask5.png').convert('L')).to('cuda').unsqueeze(0)
    #patch_mask = F.interpolate(patch_mask, (250, 250))



    test1_crop= img * (1 - patch_mask) + adv_patch * patch_mask
    test1_crop = F.interpolate(test1_crop, (256, 256))
    test1_crop = np.transpose(np.array(test1_crop.cpu(), dtype=np.float32), [0,2,3,1])

elif 0:
    test1_crop = functions.preprocess_face_woDet("/face/Mask/AdversarialMask/patch/experiments/April/13-04-2023_17-11-46/saved_patches/patch_49.png", input_shape)
    #test1_crop = functions.preprocess_face_woDet("/face/Mask/AdversarialMask/patch/experiments/April/13-04-2023_17-11-46/saved_patches/patch_1.png", input_shape)

    #test1_crop = functions.preprocess_face_woDet("/face/Mask/AdversarialMask/patch/experiments/April/05-04-2023_17-40-06/saved_patches/patch_1.png", input_shape) #T-shape



    #test1_crop = functions.preprocess_face_woDet("/face/Mask/AdversarialMask/datasets/CASIA/4204960/078_aligned.png", input_shape)
    print(test1_crop.shape)
...
#DiffusionCLIP based on our ddim
elif 1:
    #test1_crop = functions.preprocess_face_woDet("/face/Mask/DiffusionCLIP/runs/test_nio_FT_adv_CelebA_HQ_beards_id_1.0_l1_0.0_clip_0/image_samples/train_1_person_with_beards_14_ngen4.png", input_shape)
    test1_crop = functions.preprocess_face_woDet("/face/Mask/DiffusionCLIP/runs/test_nio_FT_adv_CelebA_HQ_beards_id_1.0_l1_0.0_clip_0/image_samples/train_1_person_with_beards_5_ngen4.png", input_shape)

    test1_crop = functions.preprocess_face_woDet("/face/Mask/DiffusionCLIP/runs/test_nio_FT_adv_CelebA_HQ_beards_id_1.0_l1_0.0_clip_0/image_samples/test_1_0_orig.png", input_shape)
    test1_crop = functions.preprocess_face_woDet("/face/Mask/DiffusionCLIP/runs/test_nio_FT_adv_CelebA_HQ_beards_id_1.0_l1_0.0_clip_0/image_samples/test_1_person_with_beards_1_ngen40.png", input_shape)
    test1_crop = functions.preprocess_face_woDet("/face/Mask/DiffusionCLIP/runs/test_nio_FT_adv_CelebA_HQ_beards_id_1.0_l1_0.0_clip_0/image_samples/test_1_person_with_beards_3_ngen40.png", input_shape)
    test1_crop = functions.preprocess_face_woDet("/face/Mask/DiffusionCLIP/runs/test_nio_FT_adv_CelebA_HQ_beards_id_1.0_l1_0.0_clip_0/image_samples/test_1_person_with_beards_4_ngen40.png", input_shape)
...
'''
#test1_diffpure = Image.open('/sdiff/DiffPure/outputs/before_defended.png').convert('RGB').filter(ImageFilter.GaussianBlur(radius=2))
test1_diffpure = Image.open('/sdiff/DiffPure/outputs/before_defended.png').convert('RGB').filter(ImageFilter.BoxBlur(radius=8))
#test1_diffpure = Image.open('/sdiff/DiffPure/outputs/before_defended.png').convert('RGB').filter(ImageFilter.SMOOTH_MORE)
test1_diffpure = np.expand_dims(np.transpose(np.array(test1_diffpure, dtype=np.float32), [0,1,2]), axis = 0 )
test1_diffpure_after = test1_diffpure/255.
print(test1_diffpure_after.shape)
'''
