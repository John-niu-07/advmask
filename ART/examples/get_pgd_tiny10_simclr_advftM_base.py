...
'''
print('vis feat for tiny withoutM base')
x_test, y_test = x_test[:500], y_test[:500]
np.save('y_tiny_woM_base.npy',y_test)
'''
...
class ResNetSimCLR_ft(nn.Module):
    ...
    def forward(self, x):
        ...
        #np.save('x'+str(self.kk)+'_tiny_woM_base.npy',x_save)
        #np.save('x'+str(self.kk)+'_tiny_wM_base.npy',x_save)
        #np.save('x'+str(self.kk)+'_tiny_woM_base_eps8.npy',x_save)
        np.save('x'+str(self.kk)+'_tiny_wM_base_eps8.npy',x_save)
        self.kk = self.kk + 1
        '''
...
if 1:
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_wM_base.model')
    model_ft = torch.load('/art/model_tiny/clr/model_tiny64_wM_base_eps4.model')
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_wM_base_eps8.model')
...
if 1:
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_woM_base.model')
    model_ft = torch.load('/art/model_tiny/clr/model_tiny64_woM_base_eps4.model')
    #model_ft = torch.load('/art/model_tiny/clr/model_tiny_woM_base_eps8.model')
...
#classifier.save('model_tiny_woM_base','/art/model_tiny/clr/')
#classifier.save('model_tiny64_woM_base_eps4','/art/model_tiny/clr/')
#classifier.save('model_tiny_woM_base_eps8','/art/model_tiny/clr/')
...
#np.save('x_test_adv_tiny64_base_eps4.npy', x_test_adv)
x_test_adv = np.load('x_test_adv_tiny64_base_eps4.npy')

#np.save('x_test_adv_tiny_base.npy', x_test_adv)
#x_test_adv = np.load('x_test_adv_tiny_base.npy')

#np.save('x_test_adv_tiny_base_eps8.npy', x_test_adv)
#x_test_adv = np.load('x_test_adv_tiny_base_eps8.npy')
...
np.save('x_train_adv_tiny_base.npy', x_train_adv)
#x_train_adv = np.load('x_train_adv_tiny_base.npy')
...
#classifierD.save('model_tiny_wM_base','/art/model_tiny/clr/')
#classifierD.save('model_tiny64_wM_base_eps4','/art/model_tiny/clr/')
#classifierD.save('model_tiny_wM_base_eps8','/art/model_tiny/clr/')

'''
print('vis feat for tiny withM base.........')
for k in range(0, 15):
    print(k)
    x_t = x_test[k*32:k*32+32]
...
np.save('x_test_adv2_tiny64_base_eps4.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_tiny64_base_eps4.npy')

#np.save('x_test_adv2_tiny_base.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_tiny_base.npy')

#np.save('x_test_adv2_tiny_base_eps8.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_tiny_base_eps8.npy')
