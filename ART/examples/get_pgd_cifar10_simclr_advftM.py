...
#classifier.fit_predict(x_train, y_train, x_test, y_test, batch_size=4096, nb_epochs=51)
...
#trainer = AdversarialTrainerMadryPGD(classifierD, nb_epochs=20, batch_size=256, eps= 2.0 /255.0, eps_step = 2.0/255.0)
