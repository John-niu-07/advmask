...
#test1_diffpure = Image.open('/sdiff/DiffPure/outputs/before_defended.png').convert('RGB').filter(ImageFilter.BoxBlur(radius=2))
test1_diffpure = Image.open('/sdiff/DiffPure/outputs/before_defended.png').convert('RGB').filter(ImageFilter.MedianFilter(size=7))
