...
from art.preactresnet import PreActBlock, PreActBottleneck, PreActResNet, PreActResNet18, initialize_weights, PreActResNet18STL
...
transform2 = transforms.Compose(
            #[transforms.RandomCrop(32, padding=4), transforms.RandomHorizontalFlip(), transforms.ToTensor()]
            [transforms.ToTensor(), transforms.RandomCrop(96, padding=4), transforms.RandomHorizontalFlip()]
            #[transforms.ToTensor()]
            )
...
#lod = torch.load('/art/SimCLR/runs/May24_09-07-49_glenn-Z690-UD-DDR4/checkpoint_0406.pth.tar')
#print(lod.keys())
#lod_state = lod['state_dict']

lod = torch.load('/art/SimCLR2/pytorch-simclr-simclr-master/checkpoint/stl.pth')
#print(lod.keys())
lod_state = lod['net']
...
#scheduler = torch.optim.lr_scheduler.MultiStepLR(opt, milestones=[20, 50, 70, 120], gamma=0.5)
...
#classifier.fit_predict(x_train, y_train, x_test, y_test, batch_size=64, nb_epochs=200)
...
classifier.save('model_stl_clr_dim16_nor','/art/model_stl/clr/')
