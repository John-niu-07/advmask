...
class ResNetSimCLR_ft(nn.Module):
    ...
    def forward(self, x):
        ...
        #np.save('x'+str(self.kk)+'_cifar_woM_base_eps2.npy',x_save)
        np.save('x'+str(self.kk)+'_cifar_wM_base_eps2.npy',x_save)
        #np.save('x'+str(self.kk)+'_cifar_woM_base_eps4.npy',x_save)
        #np.save('x'+str(self.kk)+'_cifar_wM_base_eps4.npy',x_save)
        #np.save('x'+str(self.kk)+'_cifar_woM_base_eps8.npy',x_save)
        #np.save('x'+str(self.kk)+'_cifar_wM_base_eps8.npy',x_save)
        self.kk = self.kk + 1
...
if 1:
    model_ft = torch.load('/art/model_cifar/clr/model_cifar_wM_base_eps2.model')
    #model_ft = torch.load('/art/model_cifar/clr/model_cifar_wM_base_eps4.model')
    #model_ft = torch.load('/art/model_cifar/clr/model_cifar_wM_base_eps8.model')
...
if 1:
    model_ft = torch.load('/art/model_cifar/clr/model_cifar_woM_base_eps2.model')
    #model_ft = torch.load('/art/model_cifar/clr/model_cifar_woM_base_eps4.model')
    #model_ft = torch.load('/art/model_cifar/clr/model_cifar_woM_base_eps8.model')
    model.load_state_dict(model_ft)
...
'''
print('vis feat for cifar withoutM base.........')
for k in range(0, 15):
    print(k)
...
#classifier.save('model_cifar_woM_base','/art/model_cifar/clr/')
##classifier.save('model_cifar_woM_base_pre34','/art/model_cifar/clr/')


#classifier.save('model_cifar_woM_base_eps2','/art/model_cifar/clr/')
#classifier.save('model_cifar_woM_base_eps4','/art/model_cifar/clr/')
#classifier.save('model_cifar_woM_base_eps8','/art/model_cifar/clr/')
...
#np.save('x_test_adv_cifar_base_eps2.npy', x_test_adv)
x_test_adv = np.load('x_test_adv_cifar_base_eps2.npy')

#np.save('x_test_adv_cifar_base_eps4.npy', x_test_adv)
#x_test_adv = np.load('x_test_adv_cifar_base_eps4.npy')

#np.save('x_test_adv_cifar_base_eps8.npy', x_test_adv)
#x_test_adv = np.load('x_test_adv_cifar_base_eps8.npy')
...
trainer = AdversarialTrainerMadryPGD(classifierD, nb_epochs=20, batch_size=64, eps= 2.0 /255.0, eps_step = 2.0/255.0)
...
#classifierD.save('model_cifar_wM_base_eps2','/art/model_cifar/clr/')
#classifierD.save('model_cifar_wM_base_eps4','/art/model_cifar/clr/')
#classifierD.save('model_cifar_wM_base_eps8','/art/model_cifar/clr/')



print('vis feat for cifar withM base.........')
for k in range(0, 15):
    print(k)
    x_t = x_test[k*32:k*32+32]
...
#np.save('x_test_adv2_cifar_base_eps2.npy', x_test_adv2)
x_test_adv2 = np.load('x_test_adv2_cifar_base_eps2.npy')

#np.save('x_test_adv2_cifar_base_eps4.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_cifar_base_eps4.npy')

#np.save('x_test_adv2_cifar_base_eps8.npy', x_test_adv2)
#x_test_adv2 = np.load('x_test_adv2_cifar_base_eps8.npy')
