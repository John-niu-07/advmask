...
class FaceClassifier(Model):
    ...
    def __init__(self):
        ...
        img4 = functions.preprocess_face("dataset/img40.jpg", input_shape)
...
attack_ap = AdversarialPatch(
            ...
            max_iter=40,
            #patch_shape=(28, 28, 1),
            patch_shape=(patch_size[0], patch_size[1], 3),
            verbose=False,
            )
...
if 0:
    ...
    #mask[:, 0:30, 51:61] = np.ones((8, 30, 10)).astype(bool)
    mask[:, 51:61, 51:61] = np.ones((8, 10, 10)).astype(bool)
