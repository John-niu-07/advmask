...
if 0:
    ...
    #lod = torch.load('/art/MoCo/Adversarial-Robustness-Self-Supervised-Learning-main/checkpoints2/encoder_q_dict_0800.pth.tar')
    lod = torch.load('/art/MoCo/Adversarial-Robustness-Self-Supervised-Learning-main/checkpoints2/encoder_q_dict_0798.pth.tar')
    print('MoCo')
