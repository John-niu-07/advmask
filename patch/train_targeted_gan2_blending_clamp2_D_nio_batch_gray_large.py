...
import utilsD_opencvalign_large as utils
import losses
from config_ganD_opencvalign_large import patch_config_types
...
class AdversarialMask:
    ...
    def loss_fn(self, patch_embs, D_loss, cls_id, latent_z, adv_patch, epoch):
    ...
    def forward_step(self, img_batch, latent_z, cls_id, epoch):
        ...
        D_loss = pred_inv[0][0]
        loss = self.loss_fn(patch_embs, D_loss, cls_id, latent_z, adv_patch, epoch)
