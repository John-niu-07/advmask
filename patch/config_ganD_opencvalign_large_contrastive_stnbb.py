...
class BaseConfiguration:
    def __init__(self):
        ...
        # Attack options
        self.mask_aug = True
        self.patch_size = (250, 250)  # height, width
        ...
        self.train_embedder_names = ['resnet100_arcface', 'resnet50_arcface', 'resnet34_arcface', 'resnet18_arcface',
