...
def main():
    ...
    img = Image.open('/face/Mask/AdversarialMask/datasets/phy/004_aligned.png').convert('RGB')


    img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/001_aligned.png').convert('RGB')
    img3 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/002_aligned.png').convert('RGB')
    img4 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/003_aligned.png').convert('RGB')
    img5 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/004_aligned.png').convert('RGB')
    img6 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/005_aligned.png').convert('RGB')
    img7 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/006_aligned.png').convert('RGB')
    ...
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/001_aligned.png').convert('RGB')
