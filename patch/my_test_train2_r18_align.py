...
from config_test import patch_config_types
...
def main():
    ...
    #adv_mask = Image.open('../data/masks/final_patch.png').convert('RGB')
        ...
        #self.test_embedder_names = ['resnet100_arcface']
        #self.test_embedder_names = ['resnet100_cosface']
        #self.test_embedder_names = ['resnet18_cosface']
        #self.test_embedder_names = ['resnet50_arcface']
        #self.test_embedder_names = ['resnet34_arcface']


    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/06-10-2022_09-44-48/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/06-10-2022_10-25-01/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/06-10-2022_10-58-51/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/06-10-2022_11-24-07/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/06-10-2022_12-15-36/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/06-10-2022_12-34-20/final_results/final_patch.png').convert('RGB')
    
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/13-10-2022_08-57-23/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/13-10-2022_09-21-26/final_results/final_patch.png').convert('RGB')
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/13-10-2022_09-45-20/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/13-10-2022_10-25-58/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/13-10-2022_10-48-51/final_results/final_patch.png').convert('RGB')
    ...
    #embeddings = all_embeddings['resnet18_arcface']
    embeddings = all_embeddings[evaluator.config.test_embedder_names[0]]
    ...
    #embeddingsP = allP_embeddings['resnet18_arcface']
    embeddingsP = allP_embeddings[evaluator.config.test_embedder_names[0]]
    ...
    #embeddingsP2 = allP2_embeddings['resnet18_arcface']
    embeddingsP2 = allP2_embeddings[evaluator.config.test_embedder_names[0]]
    ...
    #embeddings2 = all_embeddings2['resnet18_arcface']
    embeddings2 = all_embeddings2[evaluator.config.test_embedder_names[0]]
    ...
    #embeddings3 = all_embeddings3['resnet18_arcface']
    embeddings3 = all_embeddings3[evaluator.config.test_embedder_names[0]]
    ...
    embeddings4 = all_embeddings4[evaluator.config.test_embedder_names[0]]
    ...
    embeddings5 = all_embeddings5[evaluator.config.test_embedder_names[0]]
    ...
    embeddings6 = all_embeddings6[evaluator.config.test_embedder_names[0]]
    ...
    embeddings7 = all_embeddings7[evaluator.config.test_embedder_names[0]]
