...
def main():
    ...
    if ll > 2:
        adv_mask2 = imgs[9].clamp_(-1., 1.)*0.5 + 0.5
    ...
    if ll > 3:
        adv_mask3 = imgs[10].clamp_(-1., 1.)*0.5 + 0.5
    ...
    if ll > 4:
        adv_mask4 = imgs[11].clamp_(-1., 1.)*0.5 + 0.5
    ...
    if ll > 5:
        adv_mask5 = imgs[12].clamp_(-1., 1.)*0.5 + 0.5
    ...
    if ll > 6:
        adv_mask6 = imgs[13].clamp_(-1., 1.)*0.5 + 0.5
    ...
    if ll > 7:
        adv_mask7 = imgs[14].clamp_(-1., 1.)*0.5 + 0.5
    ...
    if ll > 8:
        adv_mask8 = imgs[15].clamp_(-1., 1.)*0.5 + 0.5
