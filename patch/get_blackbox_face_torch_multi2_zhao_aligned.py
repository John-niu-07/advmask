...
class Net(nn.Module):
    def __init__(self, config):
        ...
        img1 = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/001_aligned.png").convert('RGB')).to(device).unsqueeze(0)
        ...
        img2 = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/011_aligned.png").convert('RGB')).to(device).unsqueeze(0)	
        ...
        self.img_input = []
        self.preds_input = []
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/001_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/002_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/003_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/004_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/005_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/006_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/007_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/008_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/009_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/010_aligned.png").convert('RGB')).to(device).unsqueeze(0) )

        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/011_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/012_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/013_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/014_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/015_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/016_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/017_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/018_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/019_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/020_aligned.png").convert('RGB')).to(device).unsqueeze(0) )
        
        for i in range(20):
            self.img_input[i] = F.interpolate(self.img_input[i], (112, 112))
            self.preds_input.append( self.location_extractor(self.img_input[i]) )
...
img_target = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/001_aligned.png").convert('RGB')).to(device).unsqueeze(0)
...
img_input = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/011_aligned.png").convert('RGB')).to(device).unsqueeze(0)
...
#---
img_input2 = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/002_aligned.png").convert('RGB')).to(device).unsqueeze(0)
