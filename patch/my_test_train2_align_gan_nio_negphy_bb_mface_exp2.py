...
def main():
    ...
    #yyj
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/April/18-04-2023_17-06-08/final_results/final_patch.png').convert('RGB') # stn mask9 full + mag
    img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/058_aligned.png').convert('RGB')
    ...
    img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/071_aligned.png').convert('RGB')
    img3 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/073_aligned.png').convert('RGB')
    img4 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/074_aligned.png').convert('RGB')
    img5 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/075_aligned.png').convert('RGB')
    img6 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/076_aligned.png').convert('RGB')
    img7 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/081_aligned.png').convert('RGB')
    img8 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/085_aligned.png').convert('RGB')
    img9 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/090_aligned.png').convert('RGB')
    img10 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/092_aligned.png').convert('RGB')
    img11 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/094_aligned.png').convert('RGB')
    img12 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/097_aligned.png').convert('RGB')
