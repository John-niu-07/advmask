...
def main():
    ...
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/19-10-2022_23-52-46/final_results/final_patch.png').convert('RGB')


    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/24-10-2022_15-36-01/final_results/final_patch.png').convert('RGB') #w/0 stn
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/24-10-2022_15-58-29/final_results/final_patch.png').convert('RGB') #w stn
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/24-10-2022_16-25-49/final_results/final_patch.png').convert('RGB') #stn + tv
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/24-10-2022_17-33-22/final_results/final_patch.png').convert('RGB')  #Str_stn + tv
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/25-10-2022_08-52-00/final_results/final_patch.png').convert('RGB')  #Str_stn


    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/25-10-2022_09-53-26/final_results/final_patch.png').convert('RGB')  #Str_stn
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/25-10-2022_10-47-46/final_results/final_patch.png').convert('RGB')  #Str_stn + tv
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/25-10-2022_11-34-22/final_results/final_patch.png').convert('RGB')  #stn + tv
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/25-10-2022_12-04-21/final_results/final_patch.png').convert('RGB')  #stn
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/25-10-2022_12-43-05/final_results/final_patch.png').convert('RGB')  #w/o stn

    #mask07
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/30-10-2022_10-38-42/final_results/final_patch.png').convert('RGB')  # w/o stn
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/30-10-2022_11-09-38/final_results/final_patch.png').convert('RGB')  # stn + tv
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/30-10-2022_11-31-17/final_results/final_patch.png').convert('RGB')  # stn
    ...
    embeddingsP2 = allP2_embeddings['resnet100_magface']
