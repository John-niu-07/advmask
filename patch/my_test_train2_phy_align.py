...
def main():
    ...
    img = Image.open('/face/Mask/AdversarialMask/datasets/phy/001_aligned.png').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/002_aligned.png').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/003_aligned.png').convert('RGB')
    ...
    #imgP = Image.open('/face/Mask/AdversarialMask/datasets/001_aligned.png').convert('RGB')
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/000_aligned.png').convert('RGB')
