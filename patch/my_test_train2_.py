...
def main():
    ...
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/03-10-2022_09-20-58/final_results/final_patch.png').convert('RGB')
    
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/October/04-10-2022_09-45-38/final_results/final_patch.png').convert('RGB')
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/October/04-10-2022_10-13-04/final_results/final_patch.png').convert('RGB')
    ...
    img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/011.jpg').convert('RGB')
    ...
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/zhao/001.jpg').convert('RGB')
    imgP2 = Image.open('/face/Mask/AdversarialMask/datasets/zhao/021.jpg').convert('RGB')

    img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/011.jpg').convert('RGB')
    img3 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/012.jpg').convert('RGB')
    img4 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/001.jpg').convert('RGB')
    img5 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/003.jpg').convert('RGB')
    img6 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/026.jpg').convert('RGB')
    img7 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/027.jpg').convert('RGB')
