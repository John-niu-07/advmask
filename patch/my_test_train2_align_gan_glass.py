...
def main():
    ...
    img3 = Image.open('/face/Mask/AdversarialMask/patch/glass/5.png').convert('RGB')
    img4 = Image.open('/face/Mask/AdversarialMask/patch/glass/7.png').convert('RGB')
    img5 = Image.open('/face/Mask/AdversarialMask/patch/glass/9.png').convert('RGB')
    img6 = Image.open('/face/Mask/AdversarialMask/patch/glass/11.png').convert('RGB')
    img7 = Image.open('/face/Mask/AdversarialMask/patch/glass/13.png').convert('RGB')
    ...
    img_target_np = np.transpose(np.array(img_target, dtype=np.float32)/255., [2,0,1])
    img_target_np = np.expand_dims(img_target_np,0)
    img_target_t = torch.from_numpy(img_target_np).to(device)
    img_target = F.interpolate(img_target_t, (112, 112))
    img_target_ = img_target.unsqueeze(0)
    all_embeddings = evaluator.get_all_embeddings(img_input, img_target_)
    ...
    img_np1 = np.transpose(np.array(img1, dtype=np.float32)/255., [2,0,1])
    img_np1 = np.expand_dims(img_np1,0)
    img_t1 = torch.from_numpy(img_np1).to(device)
    img_input1 = F.interpolate(img_t1, (112, 112))
    img_applied1 = evaluator.apply_all_masks(img_input, img_input1)
    img_applied1_ = img_applied1.unsqueeze(0)
    all_embeddings1 = evaluator.get_all_embeddings(img_input, img_applied1_)
    embeddings1 = all_embeddings1['resnet50_arcface']
    cos1 = np.sum( embeddings1[0]*embeddings1[1] )/ (np.linalg.norm(embeddings1[1]) *np.linalg.norm(embeddings1[0]) )
    cos1_source_target = np.sum( embeddings[1]*embeddings1[1] )/ (np.linalg.norm(embeddings[1]) *np.linalg.norm(embeddings1[1]) )
    print(cos1)
    ...
    img_applied2 = evaluator.apply_all_masks(img_input, img_input2)
    ...
    cos2_source_target = np.sum( embeddings[1]*embeddings2[1] )/ (np.linalg.norm(embeddings[1]) *np.linalg.norm(embeddings2[1]) )
    print(cos2)
    ...
    img_applied3 = evaluator.apply_all_masks(img_input, img_input3)
    ...
    cos3_source_target = np.sum( embeddings[1]*embeddings3[1] )/ (np.linalg.norm(embeddings[1]) *np.linalg.norm(embeddings3[1]) )
    print(cos3)
    ...
    img_applied4 = evaluator.apply_all_masks(img_input, img_input4)
    ...
    cos4_source_target = np.sum( embeddings[1]*embeddings4[1] )/ (np.linalg.norm(embeddings[1]) *np.linalg.norm(embeddings4[1]) )
    print(cos4)
    ...
    img_applied5 = evaluator.apply_all_masks(img_input, img_input5)
    ...
    cos5_source_target = np.sum( embeddings[1]*embeddings5[1] )/ (np.linalg.norm(embeddings[1]) *np.linalg.norm(embeddings5[1]) )
    print(cos5)
    ...
    img_applied6 = evaluator.apply_all_masks(img_input, img_input6)
    ...
    cos6_source_target = np.sum( embeddings[1]*embeddings6[1] )/ (np.linalg.norm(embeddings[1]) *np.linalg.norm(embeddings6[1]) )
    print(cos6)
    ...
    img_applied7 = evaluator.apply_all_masks(img_input, img_input7)
    ...
    cos7_source_target = np.sum( embeddings[1]*embeddings7[1] )/ (np.linalg.norm(embeddings[1]) *np.linalg.norm(embeddings7[1]) )
    print(cos7)
    ...
    plt.imshow(np.transpose(img_target[0].cpu(),[1,2,0]))
    plt.axis('off')
    plt.text(0, 0., "%s " % (cos))
    ...
    plt.imshow(np.transpose(img_applied1[0].cpu(),[1,2,0]))
    #plt.imshow(np.transpose(img_input1[0].cpu(),[1,2,0]))
    plt.axis('off')
    plt.text(0, 0., "%s " % (cos1_source_target))
