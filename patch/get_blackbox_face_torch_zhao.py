...
class Net(nn.Module):
    def __init__(self, config):
        ...
        self.img_input = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/011.jpg").convert('RGB')).to(device).unsqueeze(0)	
