...
def main():
    ...
    embeddings2 = all_embeddings2['resnet100_arcface']
    cos2 = np.sum( embeddings2[0]*embeddings2[1] )/ (np.linalg.norm(embeddings2[1]) *np.linalg.norm(embeddings2[0]) )
    print(cos2)


    img_np3 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    img_np4 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings4 = all_embeddings4['resnet34_arcface']
    cos4 = np.sum( embeddings4[0]*embeddings4[1] )/ (np.linalg.norm(embeddings4[1]) *np.linalg.norm(embeddings4[0]) )
    print(cos4)

    img_np5 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings5 = all_embeddings5['resnet18_arcface']
    cos5 = np.sum( embeddings5[0]*embeddings5[1] )/ (np.linalg.norm(embeddings5[1]) *np.linalg.norm(embeddings5[0]) )
    print(cos5)

    img_np6 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings6 = all_embeddings6['resnet100_cosface']
    cos6 = np.sum( embeddings6[0]*embeddings6[1] )/ (np.linalg.norm(embeddings6[1]) *np.linalg.norm(embeddings6[0]) )
    print(cos6)

    img_np7 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings7 = all_embeddings7['resnet50_cosface']
    ...
    img_np8 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings8 = all_embeddings8['resnet34_cosface']
    cos8 = np.sum( embeddings8[0]*embeddings8[1] )/ (np.linalg.norm(embeddings8[1]) *np.linalg.norm(embeddings8[0]) )
    print(cos8)



    img_np9 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings9 = all_embeddings9['resnet18_cosface']
    ...
    img_np10 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings10 = all_embeddings10['resnet100_magface']
    cos10 = np.sum( embeddings10[0]*embeddings10[1] )/ (np.linalg.norm(embeddings10[1]) *np.linalg.norm(embeddings10[0]) )
    print(cos10)

    img_np11 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings11 = all_embeddings11['resnet50_magface']
    cos11 = np.sum( embeddings11[0]*embeddings11[1] )/ (np.linalg.norm(embeddings11[1]) *np.linalg.norm(embeddings11[0]) )
    print(cos11)

    img_np12 = np.transpose(np.array(img2, dtype=np.float32)/255., [2,0,1])
    ...
    embeddings12 = all_embeddings12['resnet18_magface']
