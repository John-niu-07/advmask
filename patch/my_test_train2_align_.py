...
def main():
    ...
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/13-10-2022_08-10-50/final_results/final_patch.png').convert('RGB')
    ...
    img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/011_aligned.png').convert('RGB')
    ...
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/zhao/001_aligned.png').convert('RGB')
    imgP2 = Image.open('/face/Mask/AdversarialMask/datasets/zhao/021_aligned.png').convert('RGB')

    img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/011_aligned.png').convert('RGB')
    img3 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/012_aligned.png').convert('RGB')
    img4 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/001_aligned.png').convert('RGB')
    img5 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/002_aligned.png').convert('RGB')
    img6 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/004_aligned.png').convert('RGB')
    img7 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/005_aligned.png').convert('RGB')
