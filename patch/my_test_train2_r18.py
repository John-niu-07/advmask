...
def main():
    ...
    #img = Image.open('/art/adversarial-robustness-toolbox/examples/dataset/img32.jpg').convert('RGB')
    img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/011.jpg').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/advmask.jpg').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/0005238/047.jpg').convert('RGB')
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/012.jpg').convert('RGB')
    imgP2 = Image.open('/face/Mask/AdversarialMask/datasets/009.jpg').convert('RGB')
    ...
    #img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/0001152/110.jpg').convert('RGB')
