...
class Net(nn.Module):
    def __init__(self, config):
        ...
        self.img_input = []
        self.preds_input = []
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/001.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/002.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/003.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/004.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/005.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/006.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/007.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/008.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/009.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/010.jpg").convert('RGB')).to(device).unsqueeze(0) )

        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/011.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/012.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/013.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/014.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/015.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/016.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/017.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/018.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/019.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/020.jpg").convert('RGB')).to(device).unsqueeze(0) )
