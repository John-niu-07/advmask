...
def main():
    ...
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/07-10-2022_21-26-41/final_results/final_patch.png').convert('RGB')
    ...
    #img = Image.open('/face/Mask/AdversarialMask/datasets/009.jpg').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/101.jpg').convert('RGB')
    img = Image.open('/face/Mask/AdversarialMask/datasets/113.jpg').convert('RGB')

    #img = Image.open('/face/Mask/AdversarialMask/datasets/201.jpg').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/302.jpg').convert('RGB')

    img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/001.jpg').convert('RGB')
    img3 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/002.jpg').convert('RGB')
    img4 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/003.jpg').convert('RGB')
    img5 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/004.jpg').convert('RGB')
    img6 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/005.jpg').convert('RGB')
    img7 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/006.jpg').convert('RGB')
    ...
    #imgP = Image.open('/face/Mask/AdversarialMask/datasets/001.jpg').convert('RGB')
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/000.jpg').convert('RGB')
