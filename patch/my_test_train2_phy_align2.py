...
class Evaluator:
    ...
    def apply_all_masks(self, img_batch):
        ...
        img_batch_applied = utils.apply_mask(self.location_extractor,
                                                  self.fxz_projector, img_batch,
                                                  #self.blue_mask_t[:, :3], self.blue_mask_t[:, 3], is_3d=True)        
                                                  adv_patch, self.blue_mask_t[:, 3], is_3d=True)
                                                  #adv_patch)#, self.blue_mask_t[:, 3], is_3d=True)
                                                  #self.face1_mask_t[:, :3], self.face1_mask_t[:, 3], is_3d=True)
                                                  #self.face3_mask_t[:, :3], self.face3_mask_t[:, 3], is_3d=True)
                                                  #self.random_mask_t, self.face3_mask_t[:, 3], is_3d=True)
...
def main():
    ...
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/September/30-09-2022_14-26-20/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/September/30-09-2022_14-22-14/final_results/final_patch.png').convert('RGB')
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/12-10-2022_11-22-59/final_results/final_patch.png').convert('RGB') #useless
    ...
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/155829/001_aligned.png').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/155829/002_aligned.png').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/155829/003_aligned.png').convert('RGB')

    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/153601/001c_.jpg').convert('RGB')

    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/162549/001_aligned.png').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/162549/002_aligned.png').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/162549/004_aligned.png').convert('RGB')

    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/113839/004_aligned.png').convert('RGB')

    img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/120653/005_aligned.png').convert('RGB')

    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/173322/004_aligned.png').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/173322/005_aligned.png').convert('RGB')

    img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/001_aligned.png').convert('RGB')
    img3 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/002_aligned.png').convert('RGB')
    img4 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/003_aligned.png').convert('RGB')
    img5 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/004_aligned.png').convert('RGB')
    img6 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/005_aligned.png').convert('RGB')
    img7 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4204960/006_aligned.png').convert('RGB')
    ...
    embeddings = all_embeddings['resnet100_magface']
    ...
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/phy/open/001_aligned.png').convert('RGB')
    ...
    embeddingsP = allP_embeddings['resnet100_magface']
    ...
    embeddings2 = all_embeddings2['resnet100_magface']
    cos2_source_target = np.sum( embeddings[0]*embeddings2[0] )/ (np.linalg.norm(embeddings[0]) *np.linalg.norm(embeddings2[0]) )
    cos2_ref = np.sum( embeddingsP[0]*embeddings2[0] )/ (np.linalg.norm(embeddingsP[0]) *np.linalg.norm(embeddings2[0]) )
    ...
    embeddings3 = all_embeddings3['resnet100_magface']
    cos3_source_target = np.sum( embeddings[0]*embeddings3[0] )/ (np.linalg.norm(embeddings[0]) *np.linalg.norm(embeddings3[0]) )
    cos3_ref = np.sum( embeddingsP[0]*embeddings3[0] )/ (np.linalg.norm(embeddingsP[0]) *np.linalg.norm(embeddings3[0]) )
    ...
    embeddings4 = all_embeddings4['resnet100_magface']
    cos4_source_target = np.sum( embeddings[0]*embeddings4[0] )/ (np.linalg.norm(embeddings[0]) *np.linalg.norm(embeddings4[0]) )
    cos4_ref = np.sum( embeddingsP[0]*embeddings4[0] )/ (np.linalg.norm(embeddingsP[0]) *np.linalg.norm(embeddings4[0]) )
    ...
    embeddings5 = all_embeddings5['resnet100_magface']
    cos5_source_target = np.sum( embeddings[0]*embeddings5[0] )/ (np.linalg.norm(embeddings[0]) *np.linalg.norm(embeddings5[0]) )
    cos5_ref = np.sum( embeddingsP[0]*embeddings5[0] )/ (np.linalg.norm(embeddingsP[0]) *np.linalg.norm(embeddings5[0]) )
    ...
    embeddings6 = all_embeddings6['resnet100_magface']
    cos6_source_target = np.sum( embeddings[0]*embeddings6[0] )/ (np.linalg.norm(embeddings[0]) *np.linalg.norm(embeddings6[0]) )
    cos6_ref = np.sum( embeddingsP[0]*embeddings6[0] )/ (np.linalg.norm(embeddingsP[0]) *np.linalg.norm(embeddings6[0]) )
    ...
    embeddings7 = all_embeddings7['resnet100_magface']
    cos7_source_target = np.sum( embeddings[0]*embeddings7[0] )/ (np.linalg.norm(embeddings[0]) *np.linalg.norm(embeddings7[0]) )
    cos7_ref = np.sum( embeddingsP[0]*embeddings7[0] )/ (np.linalg.norm(embeddingsP[0]) *np.linalg.norm(embeddings7[0]) )
