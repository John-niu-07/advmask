...
def main():
    ...
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/April/17-04-2023_09-49-04/final_results/final_patch.png').convert('RGB') # stn mask10 full + mag
