...
class Net(nn.Module):
    def __init__(self, config):
        ...
        img1 = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735//011_aligned.png").convert('RGB')).to(device).unsqueeze(0)
...
img_target = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735//011_aligned.png").convert('RGB')).to(device).unsqueeze(0)
