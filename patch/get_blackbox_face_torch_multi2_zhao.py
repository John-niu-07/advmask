...
class Net(nn.Module):
    def __init__(self, config):
        ...
        img1 = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/001.jpg").convert('RGB')).to(device).unsqueeze(0)
        ...
        img2 = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/011.jpg").convert('RGB')).to(device).unsqueeze(0)	
        ...
        self.img_input = []
        self.preds_input = []
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/001.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/002.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/003.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/004.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/005.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/006.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/007.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/008.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/009.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/010.jpg").convert('RGB')).to(device).unsqueeze(0) )

        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/011.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/012.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/013.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/014.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/015.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/016.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/017.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/018.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/019.jpg").convert('RGB')).to(device).unsqueeze(0) )
        self.img_input.append( transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/020.jpg").convert('RGB')).to(device).unsqueeze(0) )
...
img_target = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/001.jpg").convert('RGB')).to(device).unsqueeze(0)
...
img_input = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/011.jpg").convert('RGB')).to(device).unsqueeze(0)
...
#---
img_input2 = transforms.ToTensor()(Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/002.jpg").convert('RGB')).to(device).unsqueeze(0)
