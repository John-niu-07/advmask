...
class AdversarialMask:
    ...
    def train(self):
        ...
        if 0:
            ...
            self.latent_neg_z1 = torch.from_numpy(np.load('latent_z_adv8C_1.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z2 = torch.from_numpy(np.load('latent_z_adv8C_2.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z3 = torch.from_numpy(np.load('latent_z_adv8C_3.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z4 = torch.from_numpy(np.load('latent_z_adv8C_4.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z5 = torch.from_numpy(np.load('latent_z_adv8C_5.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z6 = torch.from_numpy(np.load('latent_z_adv8C_6.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z7 = torch.from_numpy(np.load('latent_z_adv8C_7.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z8 = torch.from_numpy(np.load('latent_z_adv8C_8.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z9 = torch.from_numpy(np.load('latent_z_adv8C_9.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z10 = torch.from_numpy(np.load('latent_z_adv8C_10.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z11 = torch.from_numpy(np.load('latent_z_adv8C_11.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z12 = torch.from_numpy(np.load('latent_z_adv8C_12.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z13 = torch.from_numpy(np.load('latent_z_adv8C_13.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z14 = torch.from_numpy(np.load('latent_z_adv8C_14.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z15 = torch.from_numpy(np.load('latent_z_adv8C_15.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z16 = torch.from_numpy(np.load('latent_z_adv8C_16.npy')[0].reshape((1, 7168))).clone()
            self.latent_neg_z17 = torch.from_numpy(np.load('latent_z_adv8C_17.npy')[0].reshape((1, 7168))).clone()
    ...
    def loss_fn(self, patch_embs, tv_loss, cls_id, latent_z, epoch):
        ...
        rad = 8
        #total_loss += 10*torch.clamp( 5-torch.norm(latent_z - self.latent_neg_z1, p=2), min=0)
        total_loss += 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z1, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z2, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z3, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z4, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z5, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z6, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z7, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z8, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z9, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z10, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z11, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z12, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z13, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z14, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z15, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z16, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z17, p=2), min=0) + 10*torch.clamp( rad -torch.norm(latent_z - self.latent_neg_z18, p=2), min=0)
        ...
        #    np.save('latent_z_adv8C_1.npy', latent_z_np)
        #    np.save('latent_z_adv8C_2.npy', latent_z_np)
        #    np.save('latent_z_adv8C_3.npy', latent_z_np)
        #    np.save('latent_z_adv8C_4.npy', latent_z_np)
        #    np.save('latent_z_adv8C_5.npy', latent_z_np)
        #    np.save('latent_z_adv8C_6.npy', latent_z_np)
        #    np.save('latent_z_adv8C_7.npy', latent_z_np)
        #    np.save('latent_z_adv8C_8.npy', latent_z_np)
        #    np.save('latent_z_adv8C_9.npy', latent_z_np)
        #    np.save('latent_z_adv8C_10.npy', latent_z_np)
        #    np.save('latent_z_adv8C_11.npy', latent_z_np)
        #    np.save('latent_z_adv8C_12.npy', latent_z_np)
        #    np.save('latent_z_adv8C_13.npy', latent_z_np)
        #    np.save('latent_z_adv8C_14.npy', latent_z_np)
        #    np.save('latent_z_adv8C_15.npy', latent_z_np)
        #    np.save('latent_z_adv8C_16.npy', latent_z_np)


        #    np.save('latent_z_adv8C_17.npy', latent_z_np)
        #    np.save('latent_z_adv8C_18.npy', latent_z_np)
            np.save('latent_z_adv8C_19.npy', latent_z_np)
