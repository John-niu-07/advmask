...
def main():
    ...
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/March/15-03-2023_13-46-37/final_results/final_patch.png').convert('RGB') # opencvalign_112.npy
    #img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/112.jpg').convert('RGB')

    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/March/15-03-2023_15-34-43/final_results/final_patch.png').convert('RGB') # opencvalign_088.npy
    #img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/088.jpg').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/030.jpg').convert('RGB')
    #img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/105.jpg').convert('RGB')



    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/March/15-03-2023_16-41-06/final_results/final_patch.png').convert('RGB') # w/o tv
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/March/15-03-2023_16-54-49/final_results/final_patch.png').convert('RGB') # w/ tv
    #img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/088.jpg').convert('RGB')
