...
def main():
    ...
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/October/02-10-2022_13-04-13/final_results/final_patch.png').convert('RGB')
    #adv_mask = Image.open('/face/Mask/AdversarialMask/patch/23-09-2022_22-29-12/final_results/final_patch.png').convert('RGB')
    ...
    img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/1302735/001.jpg').convert('RGB')
    ...
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/009.jpg').convert('RGB')
    ...
    plt.imshow(img)
    plt.axis('off')
    plt.text(0., 0., "w/wo mask: %s" % (cos))

    ax1 = fig.add_subplot(2,3,2)
    plt.imshow(np.transpose(img_applied[0],[1,2,0]))
    plt.axis('off')

    ax1 = fig.add_subplot(2,3,3)
    plt.imshow(imgP)
    plt.axis('off')
    plt.text(0., 0., "cross-pose: %s " % (cosP))


    ax1 = fig.add_subplot(2,3,4)
    plt.imshow(img2)
    plt.axis('off')
    plt.text(0., 0., "w/wo mask: %s" % (cos2))

    ax1 = fig.add_subplot(2,3,5)
    plt.imshow(np.transpose(img_applied2[0],[1,2,0]))
    plt.axis('off')


    ax1 = fig.add_subplot(2,3,6)
    plt.axis('off')
    plt.text(0, 0.5, "cross-orig: %s " % (cos_orig))
    plt.text(0, 0.25, "cross-masked: %s " % (cos_masked))
    plt.text(0, 0.0, "source-target: %s " % (cos_source_target))
