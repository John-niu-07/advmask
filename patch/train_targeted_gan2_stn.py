...
class AdversarialMask:
    ...
    def train(self):
        ...
        if 0:
            ...
            #latent_z_np = np.load('/face/Mask/idinvert_pytorch/results/inversion/my_test4/inverted_codes.npy').reshape((1, 7168))
    ...
    def forward_step(self, img_batch, latent_z, cls_id):
        ...
        #adv_patch = self.G.postprocess(_get_tensor_value(adv_patch))
        #adv_patch = torch.from_numpy(adv_patch).permute(0,3,1,2)/255.
