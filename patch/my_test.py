...
def main():
    ...
    adv_mask = Image.open('/face/Mask/AdversarialMask/patch/experiments/September/23-09-2022_22-29-12/final_results/final_patch.png').convert('RGB')
    ...
    img = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4773573/016.jpg').convert('RGB')
    imgP = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/4773573/017.jpg').convert('RGB')
    img2 = Image.open('/face/Mask/AdversarialMask/datasets/CASIA/5194953/007.jpg').convert('RGB')
