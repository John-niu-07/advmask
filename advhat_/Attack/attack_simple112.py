...
def main(args):
        ...
        final_crop_orig = tf.clip_by_value(face_input, 0., 1.)
        ...
        init_logo_old = np.ones((40,50,3))*127./255.
        ...
        #print(img_hat.shape)
        hat_out = np.zeros((40,50,3))
        hat_out = img_hat[0, 10:50, 31:81, : ]
        io.imsave('hat_out112.png', hat_out)
        '''
        ...
        hat_gt = io.imread('/face/hat/advhat/Attack/hat_out112.png')/255.
        ...
        while True:
                ...
                #print( np.mean(np.abs(init_logo - init_logo_old)) )
                print( np.mean(np.abs(init_logo - hat_gt)) )
                init_logo_old = init_logo.copy()

                #io.imsave('logo112_'+str(step)+'.png',init_logo)
        ...
        plt.savefig('cosine112.png')
        #io.imsave(now+'_advhat.png',init_logo)
        io.imsave('advhat112.png',init_logo)
