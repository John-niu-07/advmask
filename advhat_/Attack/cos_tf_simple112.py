...
def main(args):
        ...
        logo_0  = io.imread('/face/hat/advhat/Attack/logo112_0.png')/255.
        logo_20 = io.imread('/face/hat/advhat/Attack/logo112_20.png')/255.
        logo_40 = io.imread('/face/hat/advhat/Attack/logo112_40.png')/255.
        logo_60 = io.imread('/face/hat/advhat/Attack/logo112_60.png')/255.
        logo_80 = io.imread('/face/hat/advhat/Attack/logo112_80.png')/255.
        ...
        tfdict1 = {keep_prob:1.0, is_train:False}
        tfdict1[image_input] = prep(im_0)
        emb_0 = sess.run(embedding,feed_dict=tfdict1)
        np.save('emb_0', emb_0)
        
        
        tfdict2 = {keep_prob:1.0, is_train:False}
        tfdict2[image_input] = prep(im_20)
        emb_20 = sess.run(embedding,feed_dict=tfdict2)
        #np.save('emb_20', emb_20)
        

        tfdict3 = {keep_prob:1.0, is_train:False}
        tfdict3[image_input] = prep(im_40)
        emb_40 = sess.run(embedding,feed_dict=tfdict3)
        #np.save('emb_40', emb_40)


        tfdict4 = {keep_prob:1.0, is_train:False}
        tfdict4[image_input] = prep(im_60)
        emb_60 = sess.run(embedding,feed_dict=tfdict4)
        #np.save('emb_60', emb_60)

        tfdict5 = {keep_prob:1.0, is_train:False}
        tfdict5[image_input] = prep(im_80)
        emb_80 = sess.run(embedding,feed_dict=tfdict5)
