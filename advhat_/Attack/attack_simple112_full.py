...
def main(args):
        ...
        logo = tf.placeholder(tf.float32,shape=[None,112,112,3],name='logo_input')
        ...
        init_logo = np.ones((112,112,3))*127./255.
        ...
        hat_gt = io.imread('/face/hat/advhat/Attack/john_hat_aligned112.png')/255.
        ...
        while True:
                ...
                if step%20==0:
                        print('Stage:',stage,'Step:',step,'Loss:',round(ls[-1],5))
                        io.imsave('rec112_full_'+str(step)+'.png',init_logo)
                        #io.imsave('tmp_'+str(step)+'.png',prep(im_val))
                        #print(ls)
                step += 1
        ...
        plt.savefig('cosine112_full.png')
        #io.imsave(now+'_advhat.png',init_logo)
        io.imsave('advhat112_full.png',init_logo)
