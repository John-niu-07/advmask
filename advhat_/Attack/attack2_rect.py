...
def main(args):
        ...
        logo = tf.placeholder(tf.float32,shape=[None,900,900,3],name='logo_input')
        ...
        init_logo = np.ones((900,900,3))*127./255.
        ...
        while True:
                ...
                io.imsave('tmp_'+str(step)+'.png',im_val)
                ...
                step += 1
                if 1: #step%20==0:
                        print('Stage:',stage,'Step:',step,'Av. time:',round((time()-t)/step,2),'Loss:',round(ls[-1],5),'Coef:',regr_coef)
        ...
        io.imsave('advhat2.png',init_logo)
