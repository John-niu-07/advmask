...
def main(args):
	...
	if args.mask:
		...
		logo_input_2 = (io.imread('/face/hat/advhat/Attack/logo_20.png')/255.).reshape((1,400,900,3))
		logo_input_3 = (io.imread('/face/hat/advhat/Attack/logo_60.png')/255.).reshape((1,400,900,3))
		logo_input_4 = (io.imread('/face/hat/advhat/Attack/logo_80.png')/255.).reshape((1,400,900,3))
