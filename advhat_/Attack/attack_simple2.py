...
def main(args):
        ...
        logo = tf.placeholder(tf.float32,shape=[None,50,200,3],name='logo_input')
        ...
        mask[0, 50:100, 200:400, :] = np.ones((50, 200, 3))

        #logo_img = np.zeros((1,600,600,3))
        #logo_img[0, 50:100, 200:400, :] = logo[:, :, :, :]
        logo_img = tf.pad(logo, [[0,0],[50,500],[200,200],[0,0]])
        ...
        init_logo = np.ones((50,200,3))*127./255.
