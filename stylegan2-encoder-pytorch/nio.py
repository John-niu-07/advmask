...
imgs7 = Image.open("/face/Mask/idinvert_pytorch/examples/000005_aligned.png").convert('RGB')
imgs7 = Image.open("/face/Mask/idinvert_pytorch/examples/000019_aligned.png").convert('RGB')
...
#np.save('/face/Mask/AdversarialMask/patch/init_face000005.npy', z_now2)
np.save('/face/Mask/AdversarialMask/patch/init_face000019.npy', z_now2)
