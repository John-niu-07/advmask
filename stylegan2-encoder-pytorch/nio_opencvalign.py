...
imgs = Image.open("/face/Mask/idinvert_pytorch/examples/r256/001_aligned.png").convert('RGB')
imgs1 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/001_aligned.png").convert('RGB')
imgs2 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/002_aligned.png").convert('RGB')
imgs3 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/003_aligned.png").convert('RGB')
imgs4 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/004_aligned.png").convert('RGB')
imgs5 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/005_aligned.png").convert('RGB')
imgs6 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/006_aligned.png").convert('RGB')
imgs7 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/007_aligned.png").convert('RGB')

#opencvalign
#imgs7 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/088.jpg").convert('RGB')
#oldalign
#imgs7 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/088_aligned.png").convert('RGB')
imgs7 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/085_aligned.png").convert('RGB')
imgs7 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960/058_aligned.png").convert('RGB')

#imgs7 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/112.jpg").convert('RGB')
imgs10 = Image.open("/face/Mask/idinvert_pytorch/examples/r256/010_aligned.png").convert('RGB')
...
#imgs = transform(imgs3).unsqueeze(0).to(device)
#imgs = transform(imgs6).unsqueeze(0).to(device)
#imgs = transform(imgs10).unsqueeze(0).to(device)
imgs = transform(imgs7).unsqueeze(0).to(device)
...
for step in range(1800):
    ...
    z_now2 = z.clone().detach().cpu().numpy()
    #print(np.linalg.norm(z_now2 - z_last))

#np.save('/face/Mask/AdversarialMask/patch/target.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_face.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_face.npy', z_now)

#np.save('/face/Mask/AdversarialMask/patch/init_face3.npy', z_now2)
#np.save('/face/Mask/AdversarialMask/patch/init_face6.npy', z_now2)
#np.save('/face/Mask/AdversarialMask/patch/init_face10.npy', z_now2)
#np.save('/face/Mask/AdversarialMask/patch/init_face7.npy', z_now2)
#np.save('/face/Mask/AdversarialMask/patch/target_face.npy', z_now2)

#np.save('/face/Mask/AdversarialMask/patch/init_face3_opencvalign.npy', z_now2)
#np.save('/face/Mask/AdversarialMask/patch/init_face3_opencvalign_t.npy', z_now2)

#np.save('/face/Mask/AdversarialMask/patch/init_face3_oldalign_088.npy', z_now2)
#np.save('/face/Mask/AdversarialMask/patch/init_lh_oldalign_085.npy', z_now2)

np.save('/face/Mask/AdversarialMask/patch/init_yyj_oldalign_058.npy', z_now2)
