...
#imgs7 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/000_aligned.png").convert('RGB')
...
np.save('/face/Mask/AdversarialMask/patch/init_zhu_080.npy', z_now2)
