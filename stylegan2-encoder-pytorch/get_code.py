...
#imgs2 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735/003_aligned.png").convert('RGB')
imgs2 = Image.open("/face/deepface/deepface/dataset/img1_aligned.png").convert('RGB')
imgs2 = Image.open("/face/deepface/deepface/dataset/img3_aligned.png").convert('RGB')
imgs2 = Image.open("/face/deepface/deepface/dataset/img46_aligned.png").convert('RGB')
imgs2 = Image.open("/face/deepface/deepface/dataset/img20_aligned.png").convert('RGB')
imgs2 = Image.open("/face/deepface/deepface/dataset/img32_aligned.png").convert('RGB')
imgs2 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960_align/005_aligned.png").convert('RGB')
imgs2 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/4204960_align/004_aligned.png").convert('RGB')
imgs2 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735_align/003_aligned.png").convert('RGB')
imgs2 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735_align/001_aligned.png").convert('RGB')
imgs2 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735_align/015_aligned.png").convert('RGB')
imgs2 = Image.open("/face/Mask/AdversarialMask/datasets/CASIA/1302735_align/004_aligned.png").convert('RGB')
...
imgs = transform(imgs2).unsqueeze(0).to(device)
...
for step in range(900):
    ...
    if (step+1)%100 == 0:
        ...
        z_now = z.clone().detach().cpu().numpy()
        print(np.linalg.norm(z_now - z_last))

#np.save('/face/Mask/AdversarialMask/patch/init_face2.npy', z0.detach().cpu().numpy())
#np.save('/face/Mask/AdversarialMask/patch/init_face_003.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_img1.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_img3.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_img46.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_img20.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_img32.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_face_005.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_face_004.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_face_001.npy', z_now)
#np.save('/face/Mask/AdversarialMask/patch/init_face_015.npy', z_now)
np.save('/face/Mask/AdversarialMask/patch/init_face_004_.npy', z_now)
