...
def parse_args_and_config():
    ...
    parser.add_argument('--t', type=int, default=900, help='Sampling noise scale')
    ...
    parser.add_argument(
        '--input', type=str,
        default='./advimg/advimg.png'  #mask9
        #default='./advimg/img.png'  #mask9
        #default='/art/adversarial-robustness-toolbox/examples/dataset/img18_aligned.png'  #mask9
