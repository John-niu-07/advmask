...
from diffusionclip_adv_nio import DiffusionCLIP
...
def parse_args_and_config():
    ...
    if args.clip_finetune or args.clip_finetune_eff :
        if args.edit_attr is not None:
            #args.exp = args.exp + f'_FT_adv_{new_config.data.category}_{args.edit_attr}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
            args.exp = args.exp + f'_FT_adv_{new_config.data.category}_{args.edit_attr}_id_{args.id_loss_w}_l1_{args.l1_loss_w}_clip_{args.clip_loss_w}'
        else:
            #args.exp = args.exp + f'_FT_adv_{new_config.data.category}_{args.trg_txts}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
            args.exp = args.exp + f'_FT_adv_{new_config.data.category}_{args.trg_txts}_id_{args.id_loss_w}_l1_{args.l1_loss_w}_clip_{args.clip_loss_w}'
